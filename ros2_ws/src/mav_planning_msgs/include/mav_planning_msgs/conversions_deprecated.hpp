...
inline void vectorFromMsgArray(const msg::PolynomialSegment4D::_x_type& array, Eigen::VectorXd* x);

/// Converts an Eigen::VectorXd to a PolynomialSegment double array.
inline void msgArrayFromVector(const Eigen::VectorXd& x, msg::PolynomialSegment4D::_x_type* array);
...
inline void eigenPolynomialTrajectoryFromMsg(const msg::PolynomialTrajectory4D& msg,
    ...
    for (msg::PolynomialTrajectory4D::_segments_type::const_iterator it = msg.segments.begin();
