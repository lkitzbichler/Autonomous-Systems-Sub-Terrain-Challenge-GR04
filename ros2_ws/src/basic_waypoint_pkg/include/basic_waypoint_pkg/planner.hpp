...
class BasicPlanner {
   public:
     ...
     */
    bool planTrajectoryWithWaypoints(const std::vector<double>& waypoint_list, int stop_index,
    ...
    void drawMavTrajectory(const mav_trajectory_generation::Trajectory& trajectory, double distance,
