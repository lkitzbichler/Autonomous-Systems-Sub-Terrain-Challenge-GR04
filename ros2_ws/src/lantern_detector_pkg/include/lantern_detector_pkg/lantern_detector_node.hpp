...
private:
  ...
  rclcpp::Subscription<sensor_msgs::msg::CameraInfo>::SharedPtr sub_depth_info_; /**< CameraInfo subscription. */
  ...
  rclcpp::Publisher<std_msgs::msg::Int32MultiArray>::SharedPtr lantern_counts_pub_; /**< Observation counts. */
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr marker_pub_; /**< Visualization markers. */
