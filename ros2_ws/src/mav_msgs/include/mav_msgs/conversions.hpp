...
inline void eigenActuatorsFromMsg(const mav_msgs::msg::Actuators& msg, EigenActuators* actuators) {
...
inline void eigenRateThrustFromMsg(const mav_msgs::msg::RateThrust& msg, EigenRateThrust* rate_thrust) {
...
inline void eigenRollPitchYawrateThrustFromMsg(const mav_msgs::msg::RollPitchYawrateThrust& msg,
...
inline void eigenOdometryFromMsg(const nav_msgs::msg::Odometry& msg, EigenOdometry* odometry) {
    assert(odometry != NULL);

    rclcpp::Time timestamp = msg.header.stamp;

    odometry->timestamp_ns = timestamp.nanoseconds();
...
inline void eigenTrajectoryPointFromTransformMsg(const geometry_msgs::msg::TransformStamped& msg,
                                                 EigenTrajectoryPoint* trajectory_point) {
    assert(trajectory_point != NULL);

    rclcpp::Time timestamp = msg.header.stamp;

    trajectory_point->timestamp_ns = timestamp.nanoseconds();
...
// message.
inline void eigenTrajectoryPointFromPoseMsg(const geometry_msgs::msg::Pose& msg,
                                            EigenTrajectoryPoint* trajectory_point) {
    assert(trajectory_point != NULL);
...
inline void eigenTrajectoryPointFromPoseMsg(const geometry_msgs::msg::PoseStamped& msg,
                                            EigenTrajectoryPoint* trajectory_point) {
    assert(trajectory_point != NULL);
 ...
 */
void EigenMavStateFromEigenTrajectoryPoint(const Eigen::Vector3d& acceleration, const Eigen::Vector3d& jerk,
...
/// vector.
inline void EigenMavStateFromEigenTrajectoryPoint(const Eigen::Vector3d& acceleration,
                                                  const Eigen::Vector3d& jerk, const Eigen::Vector3d& snap,
                                                  double yaw, double yaw_rate, double yaw_acceleration,
                                                  Eigen::Quaterniond* orientation,
                                                  Eigen::Vector3d* acceleration_body,
                                                  Eigen::Vector3d* angular_velocity_body,
                                                  Eigen::Vector3d* angular_acceleration_body) {
    EigenMavStateFromEigenTrajectoryPoint(acceleration, jerk, snap, yaw, yaw_rate, yaw_acceleration, kGravity,
...
inline void EigenMavStateFromEigenTrajectoryPoint(const EigenTrajectoryPoint& trajectory_point,
                                                  double magnitude_of_gravity, EigenMavState* mav_state) {
...
inline void EigenMavStateFromEigenTrajectoryPoint(
    const Eigen::Vector3d& acceleration, const Eigen::Vector3d& jerk, const Eigen::Vector3d& snap, double yaw,
    double yaw_rate, double yaw_acceleration, double magnitude_of_gravity, Eigen::Quaterniond* orientation,
    ...
    *acceleration_body = R.transpose() * zb * thrust;
    ...
    const Eigen::Vector3d h_a = inv_thrust * (snap - double(zb.transpose() * snap) * zb) - 2 * wcrossz -
...
inline void eigenTrajectoryPointFromMsg(const trajectory_msgs::msg::MultiDOFJointTrajectoryPoint& msg,
                                        EigenTrajectoryPoint* trajectory_point) {
    assert(trajectory_point != NULL);

    if (msg.transforms.empty()) {
        RCLCPP_ERROR(rclcpp::get_logger("rclcpp"), "MultiDofJointTrajectoryPoint is empty.");
        return;
    }
    ...
    rclcpp::Duration duration = msg.time_from_start;

    trajectory_point->time_from_start_ns = duration.nanoseconds();
...
inline void eigenTrajectoryPointVectorFromMsg(const trajectory_msgs::msg::MultiDOFJointTrajectory& msg,
...
inline void eigenTrajectoryPointDequeFromMsg(const trajectory_msgs::msg::MultiDOFJointTrajectory& msg,
...
// header.
inline void msgActuatorsFromEigen(const EigenActuators& actuators, mav_msgs::msg::Actuators* msg) {
    assert(msg != NULL);
...
inline void msgRateThrustFromEigen(EigenRateThrust& rate_thrust, mav_msgs::msg::RateThrust* msg) {
    assert(msg != NULL);
    vectorEigenToMsg(rate_thrust.angular_rates, &msg->angular_rates);
    vectorEigenToMsg(rate_thrust.thrust, &msg->thrust);
}

inline void msgTorqueThrustFromEigen(EigenTorqueThrust& torque_thrust, mav_msgs::msg::TorqueThrust* msg) {
    assert(msg != NULL);
    vectorEigenToMsg(torque_thrust.torque, &msg->torque);
    vectorEigenToMsg(torque_thrust.thrust, &msg->thrust);
}

inline void msgRollPitchYawrateThrustFromEigen(const EigenRollPitchYawrateThrust& roll_pitch_yawrate_thrust,
...
inline void msgOdometryFromEigen(const EigenOdometry& odometry, nav_msgs::msg::Odometry* msg) {
    assert(msg != NULL);

    rclcpp::Time timestamp(odometry.timestamp_ns);
...
inline void msgPoseStampedFromEigenTrajectoryPoint(const EigenTrajectoryPoint& trajectory_point,
    ...
    if (trajectory_point.timestamp_ns >= 0) {
        rclcpp::Time timestamp(trajectory_point.timestamp_ns);
        msg->header.stamp = timestamp;
    }
...
inline void msgMultiDofJointTrajectoryPointFromEigen(
    const EigenTrajectoryPoint& trajectory_point, trajectory_msgs::msg::MultiDOFJointTrajectoryPoint* msg) {
    assert(msg != NULL);

    std::chrono::nanoseconds time_from_start_ns{trajectory_point.time_from_start_ns};
    rclcpp::Duration time_from_start(time_from_start_ns);
...
inline void msgMultiDofJointTrajectoryFromPositionYaw(const Eigen::Vector3d& position, double yaw,
                                                      trajectory_msgs::msg::MultiDOFJointTrajectory* msg) {
    assert(msg != NULL);
...
inline void msgMultiDofJointTrajectoryFromEigen(const EigenTrajectoryPointVector& trajectory,
    ...
    if (trajectory.empty()) {
        RCLCPP_ERROR(rclcpp::get_logger("rclcpp"), "EigenTrajectoryPointVector is empty.");
        return;
    }
