...
mav_trajectory_generation::Vertex::Vector createRandomVerticesPath(int dimension, size_t n_segments,
...
bool timeEval(int n_segments, double average_distance, size_t seed) {
    ...
    mav_trajectory_generation::timing::Timer timer_solve("polynomial_optimization_template_" +
