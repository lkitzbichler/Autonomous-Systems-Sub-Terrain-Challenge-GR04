...
class Vertex {
   public:
    ...
    bool getSubdimension(const std::vector<size_t>& subdimensions, int max_derivative_order,
...
std::vector<double> estimateSegmentTimesVelocityRamp(const Vertex::Vector& vertices, double v_max,
                                                     double a_max, double time_factor = 1.0);
...
Vertex::Vector createRandomVertices1D(int maximum_derivative, size_t n_segments, double minimum_position,
