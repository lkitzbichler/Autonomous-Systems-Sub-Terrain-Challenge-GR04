...
class PolynomialOptimization {
   ...
   public:
    ...
    static bool computeSegmentMaximumMagnitudeCandidates(const Segment& segment, double t_start,
                                                         double t_stop, std::vector<double>* candidates);

    // Template-free version of above:
    static bool computeSegmentMaximumMagnitudeCandidates(int derivative, const Segment& segment,
    ...
    // Output: candidates = Vector containing the candidate times for a maximum.
    template <int Derivative>
    static void computeSegmentMaximumMagnitudeCandidatesBySampling(const Segment& segment, double t_start,
                                                                   double t_stop, double sampling_interval,
                                                                   std::vector<double>* candidates);
