...
bool cdr_serialize_mav_msgs__msg__Actuators(
  const mav_msgs__msg__Actuators * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_deserialize_mav_msgs__msg__Actuators(
  eprosima::fastcdr::Cdr & cdr,
  mav_msgs__msg__Actuators * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_serialize_key_mav_msgs__msg__Actuators(
  const mav_msgs__msg__Actuators * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t get_serialized_size_key_mav_msgs__msg__Actuators(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Actuators__ros_msg_type * ros_message = static_cast<const _Actuators__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t max_serialized_size_key_mav_msgs__msg__Actuators(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_msgs__msg__Actuators * ros_message = static_cast<const mav_msgs__msg__Actuators *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_msgs__msg__Actuators(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_msgs__msg__Actuators * ros_message = static_cast<mav_msgs__msg__Actuators *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_msgs__msg__Actuators(cdr, ros_message);
}
