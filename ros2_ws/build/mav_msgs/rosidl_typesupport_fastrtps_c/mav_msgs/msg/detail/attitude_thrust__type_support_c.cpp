...
#include "mav_msgs/msg/detail/attitude_thrust__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/quaternion__functions.h"  // attitude
#include "geometry_msgs/msg/detail/vector3__functions.h"  // thrust
...
using _AttitudeThrust__ros_msg_type = mav_msgs__msg__AttitudeThrust;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_serialize_mav_msgs__msg__AttitudeThrust(
  const mav_msgs__msg__AttitudeThrust * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_deserialize_mav_msgs__msg__AttitudeThrust(
  eprosima::fastcdr::Cdr & cdr,
  mav_msgs__msg__AttitudeThrust * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: attitude
  {
    cdr_deserialize_geometry_msgs__msg__Quaternion(cdr, &ros_message->attitude);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t get_serialized_size_mav_msgs__msg__AttitudeThrust(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeThrust__ros_msg_type * ros_message = static_cast<const _AttitudeThrust__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t max_serialized_size_mav_msgs__msg__AttitudeThrust(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mav_msgs__msg__AttitudeThrust;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_serialize_key_mav_msgs__msg__AttitudeThrust(
  const mav_msgs__msg__AttitudeThrust * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t get_serialized_size_key_mav_msgs__msg__AttitudeThrust(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeThrust__ros_msg_type * ros_message = static_cast<const _AttitudeThrust__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t max_serialized_size_key_mav_msgs__msg__AttitudeThrust(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_msgs__msg__AttitudeThrust * ros_message = static_cast<const mav_msgs__msg__AttitudeThrust *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_msgs__msg__AttitudeThrust(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_msgs__msg__AttitudeThrust * ros_message = static_cast<mav_msgs__msg__AttitudeThrust *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_msgs__msg__AttitudeThrust(cdr, ros_message);
}

static uint32_t _AttitudeThrust__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mav_msgs__msg__AttitudeThrust(
...
static size_t _AttitudeThrust__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mav_msgs__msg__AttitudeThrust(
...
static message_type_support_callbacks_t __callbacks_AttitudeThrust = {
  "mav_msgs::msg",
  "AttitudeThrust",
...
static rosidl_message_type_support_t _AttitudeThrust__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AttitudeThrust,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_msgs, msg, AttitudeThrust)() {
  return &_AttitudeThrust__type_support;
}
