...
bool cdr_serialize_mav_msgs__msg__TorqueThrust(
  const mav_msgs__msg__TorqueThrust * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_deserialize_mav_msgs__msg__TorqueThrust(
  eprosima::fastcdr::Cdr & cdr,
  mav_msgs__msg__TorqueThrust * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: torque
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->torque);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
bool cdr_serialize_key_mav_msgs__msg__TorqueThrust(
  const mav_msgs__msg__TorqueThrust * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t get_serialized_size_key_mav_msgs__msg__TorqueThrust(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TorqueThrust__ros_msg_type * ros_message = static_cast<const _TorqueThrust__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_msgs
size_t max_serialized_size_key_mav_msgs__msg__TorqueThrust(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_msgs__msg__TorqueThrust * ros_message = static_cast<const mav_msgs__msg__TorqueThrust *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_msgs__msg__TorqueThrust(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_msgs__msg__TorqueThrust * ros_message = static_cast<mav_msgs__msg__TorqueThrust *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_msgs__msg__TorqueThrust(cdr, ros_message);
}
