...
mav_msgs__msg__GpsWaypoint__init(mav_msgs__msg__GpsWaypoint * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mav_msgs__msg__GpsWaypoint__fini(msg);
    return false;
  }
  // latitude
  // longitude
...
mav_msgs__msg__GpsWaypoint__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mav_msgs__msg__GpsWaypoint * msg = (mav_msgs__msg__GpsWaypoint *)allocator.allocate(sizeof(mav_msgs__msg__GpsWaypoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mav_msgs__msg__GpsWaypoint));
  bool success = mav_msgs__msg__GpsWaypoint__init(msg);
  if (!success) {
...
mav_msgs__msg__GpsWaypoint__Sequence__init(mav_msgs__msg__GpsWaypoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mav_msgs__msg__GpsWaypoint * data = NULL;

  if (size) {
    data = (mav_msgs__msg__GpsWaypoint *)allocator.zero_allocate(size, sizeof(mav_msgs__msg__GpsWaypoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mav_msgs__msg__GpsWaypoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mav_msgs__msg__GpsWaypoint__fini(&data[i - 1]);
      }
...
mav_msgs__msg__GpsWaypoint__Sequence__fini(mav_msgs__msg__GpsWaypoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mav_msgs__msg__GpsWaypoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mav_msgs__msg__GpsWaypoint__Sequence * array = (mav_msgs__msg__GpsWaypoint__Sequence *)allocator.allocate(sizeof(mav_msgs__msg__GpsWaypoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mav_msgs__msg__GpsWaypoint__Sequence__init(array, size);
  if (!success) {
...
mav_msgs__msg__GpsWaypoint__Sequence__destroy(mav_msgs__msg__GpsWaypoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mav_msgs__msg__GpsWaypoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mav_msgs__msg__GpsWaypoint__Sequence__are_equal(const mav_msgs__msg__GpsWaypoint__Sequence * lhs, const mav_msgs__msg__GpsWaypoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mav_msgs__msg__GpsWaypoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mav_msgs__msg__GpsWaypoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mav_msgs__msg__GpsWaypoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mav_msgs__msg__GpsWaypoint * data =
      (mav_msgs__msg__GpsWaypoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mav_msgs__msg__GpsWaypoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mav_msgs__msg__GpsWaypoint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mav_msgs__msg__GpsWaypoint__copy(
