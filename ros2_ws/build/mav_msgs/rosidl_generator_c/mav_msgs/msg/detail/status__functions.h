...
// IWYU pragma: private, include "mav_msgs/msg/status.h"


#ifndef MAV_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
#define MAV_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
 ...
 * calls
 * mav_msgs__msg__Status__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mav_msgs
mav_msgs__msg__Status *
mav_msgs__msg__Status__create(void);

/// Destroy msg/Status message.
/**
 * It calls
 * mav_msgs__msg__Status__fini()
 ...
 * mav_msgs__msg__Status__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mav_msgs__msg__Status__Sequence__fini()
 * on the array,
...
#endif  // MAV_MSGS__MSG__DETAIL__STATUS__FUNCTIONS_H_
