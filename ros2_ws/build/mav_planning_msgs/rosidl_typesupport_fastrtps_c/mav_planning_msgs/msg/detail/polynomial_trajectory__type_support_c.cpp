...
#include "mav_planning_msgs/msg/detail/polynomial_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "mav_planning_msgs/msg/detail/polynomial_segment__functions.h"  // segments
...
using _PolynomialTrajectory__ros_msg_type = mav_planning_msgs__msg__PolynomialTrajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mav_planning_msgs__msg__PolynomialSegment(
        &array_ptr[i], cdr);
    }
  }
  ...
  mav_planning_msgs__msg__PolynomialTrajectory * ros_message)
{
  ...
  // Field name: segments
  {
    ...
    if (ros_message->segments.data) {
      mav_planning_msgs__msg__PolynomialSegment__Sequence__fini(&ros_message->segments);
    }
    ...
    auto array_ptr = ros_message->segments.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mav_planning_msgs__msg__PolynomialSegment(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mav_planning_msgs__msg__PolynomialTrajectory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: segments
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mav_planning_msgs__msg__PolynomialSegment(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_planning_msgs__msg__PolynomialTrajectory * ros_message = static_cast<const mav_planning_msgs__msg__PolynomialTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_planning_msgs__msg__PolynomialTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_planning_msgs__msg__PolynomialTrajectory * ros_message = static_cast<mav_planning_msgs__msg__PolynomialTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_planning_msgs__msg__PolynomialTrajectory(cdr, ros_message);
}

static uint32_t _PolynomialTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mav_planning_msgs__msg__PolynomialTrajectory(
...
static size_t _PolynomialTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mav_planning_msgs__msg__PolynomialTrajectory(
