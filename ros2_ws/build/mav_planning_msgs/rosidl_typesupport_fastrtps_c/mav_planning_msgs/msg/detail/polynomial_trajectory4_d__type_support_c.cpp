  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mav_planning_msgs__msg__PolynomialSegment4D(
        &array_ptr[i], cdr);
    }
  }
  ...
  mav_planning_msgs__msg__PolynomialTrajectory4D * ros_message)
{
  ...
  // Field name: segments
  {
    ...
    auto array_ptr = ros_message->segments.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mav_planning_msgs__msg__PolynomialSegment4D(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: segments
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mav_planning_msgs__msg__PolynomialSegment4D(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment4D(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment4D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_planning_msgs__msg__PolynomialTrajectory4D * ros_message = static_cast<const mav_planning_msgs__msg__PolynomialTrajectory4D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_planning_msgs__msg__PolynomialTrajectory4D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_planning_msgs__msg__PolynomialTrajectory4D * ros_message = static_cast<mav_planning_msgs__msg__PolynomialTrajectory4D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_planning_msgs__msg__PolynomialTrajectory4D(cdr, ros_message);
}
