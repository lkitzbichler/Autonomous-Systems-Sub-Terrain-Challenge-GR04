  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_planning_msgs__msg__Point2D * ros_message = static_cast<const mav_planning_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_planning_msgs__msg__Point2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_planning_msgs__msg__Point2D * ros_message = static_cast<mav_planning_msgs__msg__Point2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_planning_msgs__msg__Point2D(cdr, ros_message);
}
