...
#include "mav_planning_msgs/msg/detail/polynomial_segment__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // rx, ry, rz, x, y, yaw, z
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // rx, ry, rz, x, y, yaw, z
...
using _PolynomialSegment__ros_msg_type = mav_planning_msgs__msg__PolynomialSegment;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
bool cdr_serialize_mav_planning_msgs__msg__PolynomialSegment(
  const mav_planning_msgs__msg__PolynomialSegment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: rz
  {
    size_t size = ros_message->rz.size;
    auto array_ptr = ros_message->rz.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
bool cdr_deserialize_mav_planning_msgs__msg__PolynomialSegment(
  eprosima::fastcdr::Cdr & cdr,
  mav_planning_msgs__msg__PolynomialSegment * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: rx
  {
    ...
    if (ros_message->rx.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->rx);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->rx, size)) {
  ...
  // Field name: ry
  {
    ...
    if (ros_message->ry.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->ry);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->ry, size)) {
      fprintf(stderr, "failed to create array for field 'ry'");
      return false;
    }
    auto array_ptr = ros_message->ry.data;
    cdr.deserialize_array(array_ptr, size);
  ...
  // Field name: rz
  {
    ...
    if (ros_message->rz.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->rz);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->rz, size)) {
      fprintf(stderr, "failed to create array for field 'rz'");
      return false;
    }
    auto array_ptr = ros_message->rz.data;
    cdr.deserialize_array(array_ptr, size);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
size_t get_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PolynomialSegment__ros_msg_type * ros_message = static_cast<const _PolynomialSegment__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
size_t max_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mav_planning_msgs__msg__PolynomialSegment;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
bool cdr_serialize_key_mav_planning_msgs__msg__PolynomialSegment(
  const mav_planning_msgs__msg__PolynomialSegment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
size_t get_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PolynomialSegment__ros_msg_type * ros_message = static_cast<const _PolynomialSegment__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mav_planning_msgs
size_t max_serialized_size_key_mav_planning_msgs__msg__PolynomialSegment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mav_planning_msgs__msg__PolynomialSegment * ros_message = static_cast<const mav_planning_msgs__msg__PolynomialSegment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mav_planning_msgs__msg__PolynomialSegment(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mav_planning_msgs__msg__PolynomialSegment * ros_message = static_cast<mav_planning_msgs__msg__PolynomialSegment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mav_planning_msgs__msg__PolynomialSegment(cdr, ros_message);
}

static uint32_t _PolynomialSegment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
...
static size_t _PolynomialSegment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mav_planning_msgs__msg__PolynomialSegment(
...
static message_type_support_callbacks_t __callbacks_PolynomialSegment = {
...
static rosidl_message_type_support_t _PolynomialSegment__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PolynomialSegment,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_planning_msgs, msg, PolynomialSegment)() {
  return &_PolynomialSegment__type_support;
}
