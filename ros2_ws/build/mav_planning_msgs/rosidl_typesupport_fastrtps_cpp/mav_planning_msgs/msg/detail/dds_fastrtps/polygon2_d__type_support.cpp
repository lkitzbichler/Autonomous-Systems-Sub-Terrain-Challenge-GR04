...
#include "mav_planning_msgs/msg/detail/polygon2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mav_planning_msgs::msg::Point2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mav_planning_msgs::msg::Point2D &);
...
cdr_serialize(
  const mav_planning_msgs::msg::Polygon2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mav_planning_msgs::msg::Polygon2D & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Point2D(
  ...
  if (is_plain) {
    ...
    using DataType = mav_planning_msgs::msg::Polygon2D;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
max_serialized_size_key_Polygon2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Point2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mav_planning_msgs::msg::Polygon2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mav_planning_msgs::msg::Polygon2D *>(
    untyped_ros_message);
...
static size_t _Polygon2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Polygon2D(full_bounded, is_plain, 0);
...
{
  return &mav_planning_msgs::msg::typesupport_fastrtps_cpp::_Polygon2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mav_planning_msgs, msg, Polygon2D)() {
  return &mav_planning_msgs::msg::typesupport_fastrtps_cpp::_Polygon2D__handle;
}
