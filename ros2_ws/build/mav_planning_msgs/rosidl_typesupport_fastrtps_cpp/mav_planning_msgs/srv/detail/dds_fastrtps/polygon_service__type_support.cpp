...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_PolygonWithHolesStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
max_serialized_size_key_PolygonService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: polygon
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PolygonWithHolesStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
max_serialized_size_key_PolygonService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for mav_planning_msgs::srv::PolygonService_Request already declared above

// functions for mav_planning_msgs::srv::PolygonService_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
cdr_serialize(
  const mav_planning_msgs::srv::PolygonService_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mav_planning_msgs::srv::PolygonService_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
max_serialized_size_PolygonService_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_PolygonService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_PolygonService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mav_planning_msgs::srv::PolygonService_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mav_planning_msgs
max_serialized_size_key_PolygonService_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_PolygonService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mav_planning_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_PolygonService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mav_planning_msgs::srv::PolygonService_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mav_planning_msgs::srv::PolygonService_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PolygonService_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mav_planning_msgs::srv::PolygonService_Event *>(
...
static size_t _PolygonService_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PolygonService_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PolygonService_Event__callbacks = {
  "mav_planning_msgs::srv",
...
static rosidl_message_type_support_t _PolygonService_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PolygonService_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &mav_planning_msgs::srv::typesupport_fastrtps_cpp::_PolygonService_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mav_planning_msgs, srv, PolygonService_Event)() {
  return &mav_planning_msgs::srv::typesupport_fastrtps_cpp::_PolygonService_Event__handle;
}
...
static const rosidl_service_type_support_t _PolygonService__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PolygonService__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mav_planning_msgs::srv::PolygonService_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mav_planning_msgs::srv::PolygonService_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mav_planning_msgs::srv::PolygonService_Event>(),
