...
static const _ChangeNameService_Event_type_support_symbol_names_t _ChangeNameService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mav_planning_msgs, srv, ChangeNameService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mav_planning_msgs, srv, ChangeNameService_Event)),
  }
};
...
{
  return &::mav_planning_msgs::srv::rosidl_typesupport_cpp::ChangeNameService_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mav_planning_msgs, srv, ChangeNameService_Event)() {
  return get_message_type_support_handle<mav_planning_msgs::srv::ChangeNameService_Event>();
}
...
static const rosidl_service_type_support_t ChangeNameService_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mav_planning_msgs::srv::ChangeNameService_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mav_planning_msgs::srv::ChangeNameService_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mav_planning_msgs::srv::ChangeNameService_Event>(),
