...
static char mav_planning_msgs__msg__PolygonWithHoles__FIELD_NAME__hull[] = "hull";
static char mav_planning_msgs__msg__PolygonWithHoles__FIELD_NAME__holes[] = "holes";

static rosidl_runtime_c__type_description__Field mav_planning_msgs__msg__PolygonWithHoles__FIELDS[] = {
  {
    {mav_planning_msgs__msg__PolygonWithHoles__FIELD_NAME__hull, 4, 4},
    {
  ...
  {
    {mav_planning_msgs__msg__PolygonWithHoles__FIELD_NAME__holes, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mav_planning_msgs__msg__PolygonWithHoles__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mav_planning_msgs__msg__PolygonWithHoles__FIELDS, 2, 2},
    },
    {mav_planning_msgs__msg__PolygonWithHoles__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = mav_planning_msgs__msg__Polygon2D__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mav_planning_msgs__msg__PolygonWithHoles__get_individual_type_description_source(NULL),
    sources[1] = *mav_planning_msgs__msg__Point2D__get_individual_type_description_source(NULL);
    sources[2] = *mav_planning_msgs__msg__Polygon2D__get_individual_type_description_source(NULL);
    constructed = true;
  }
