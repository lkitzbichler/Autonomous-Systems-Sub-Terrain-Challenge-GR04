...
static const _ChangeNameService_Request_type_support_symbol_names_t _ChangeNameService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_planning_msgs, srv, ChangeNameService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_planning_msgs, srv, ChangeNameService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mav_planning_msgs, srv, ChangeNameService_Request)() {
  return &::mav_planning_msgs::srv::rosidl_typesupport_c::ChangeNameService_Request_message_type_support_handle;
}
...
static const _ChangeNameService_Response_type_support_symbol_names_t _ChangeNameService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_planning_msgs, srv, ChangeNameService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_planning_msgs, srv, ChangeNameService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mav_planning_msgs, srv, ChangeNameService_Response)() {
  return &::mav_planning_msgs::srv::rosidl_typesupport_c::ChangeNameService_Response_message_type_support_handle;
}
...
typedef struct _ChangeNameService_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _ChangeNameService_Event_type_support_ids_t;

static const _ChangeNameService_Event_type_support_ids_t _ChangeNameService_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _ChangeNameService_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _ChangeNameService_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _ChangeNameService_Event_type_support_symbol_names_t _ChangeNameService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_planning_msgs, srv, ChangeNameService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_planning_msgs, srv, ChangeNameService_Event)),
  }
};

typedef struct _ChangeNameService_Event_type_support_data_t
{
  void * data[2];
} _ChangeNameService_Event_type_support_data_t;

static _ChangeNameService_Event_type_support_data_t _ChangeNameService_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _ChangeNameService_Event_message_typesupport_map = {
  2,
  "mav_planning_msgs",
  &_ChangeNameService_Event_message_typesupport_ids.typesupport_identifier[0],
  &_ChangeNameService_Event_message_typesupport_symbol_names.symbol_name[0],
  &_ChangeNameService_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t ChangeNameService_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_ChangeNameService_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mav_planning_msgs, srv, ChangeNameService_Event)() {
  return &::mav_planning_msgs::srv::rosidl_typesupport_c::ChangeNameService_Event_message_type_support_handle;
}
...
static const _ChangeNameService_type_support_symbol_names_t _ChangeNameService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_planning_msgs, srv, ChangeNameService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_planning_msgs, srv, ChangeNameService)),
  }
};
...
static const rosidl_service_type_support_t ChangeNameService_service_type_support_handle = {
  ...
  &ChangeNameService_Request_message_type_support_handle,
  &ChangeNameService_Response_message_type_support_handle,
  &ChangeNameService_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mav_planning_msgs, srv, ChangeNameService)() {
  return &::mav_planning_msgs::srv::rosidl_typesupport_c::ChangeNameService_service_type_support_handle;
}
