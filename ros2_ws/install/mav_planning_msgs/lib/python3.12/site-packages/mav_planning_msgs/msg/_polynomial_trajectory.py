...
class Metaclass_PolynomialTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mav_planning_msgs.msg import PolynomialSegment
            if PolynomialSegment.__class__._TYPE_SUPPORT is None:
                PolynomialSegment.__class__.__import_type_support__()
...
class PolynomialTrajectory(metaclass=Metaclass_PolynomialTrajectory):
    ...
    _fields_and_field_types = {
        ...
        'segments': 'sequence<mav_planning_msgs/PolynomialSegment>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mav_planning_msgs', 'msg'], 'PolynomialSegment')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, PolynomialSegment) for v in value) and
                 True), \
                "The 'segments' field must be a set or sequence and each value of type 'PolynomialSegment'"
