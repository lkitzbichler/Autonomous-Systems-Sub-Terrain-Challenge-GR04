...
// IWYU pragma: private, include "mav_msgs/msg/actuators.h"


#ifndef MAV_MSGS__MSG__DETAIL__ACTUATORS__FUNCTIONS_H_
#define MAV_MSGS__MSG__DETAIL__ACTUATORS__FUNCTIONS_H_
 ...
 * calls
 * mav_msgs__msg__Actuators__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mav_msgs
mav_msgs__msg__Actuators *
mav_msgs__msg__Actuators__create(void);

/// Destroy msg/Actuators message.
/**
 * It calls
 * mav_msgs__msg__Actuators__fini()
 ...
 * mav_msgs__msg__Actuators__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mav_msgs__msg__Actuators__Sequence__fini()
 * on the array,
...
#endif  // MAV_MSGS__MSG__DETAIL__ACTUATORS__FUNCTIONS_H_
